function [HSI_restored, removed_noise, other_result] ...
     = select_func_S3TTV_for_denoising_NPPDS(HSI_clean, HSI_noisy, params, deg)
...
if deg.sparse_rate == 0 && deg.stripe_rate == 0
    [HSI_restored, removed_noise, other_result] = ...
        func_S3TTV_g_for_denoising_NPPDS(HSI_clean, HSI_noisy, params);
...
elseif deg.sparse_rate == 0
    [HSI_restored, removed_noise, other_result] = ...
        func_S3TTV_gt_for_denoising_NPPDS(HSI_clean, HSI_noisy, params);
