...
function [HSI_restored, removed_noise, other_result] ...
     = func_SSTV_LRMR_gst_for_denoising_by_PsPPDS(HSI_clean, HSI_noisy, params)
fprintf('** Running func_SSTV_LRMR_gst_for_denoising_by_PsPPDS **\n');
...
for i = 1:maxiter
    ...
    if (mod(i, saverate) == 0)
        ...
        save(tmp_save_name, ...
            'U_curr', 'S_curr', 'T_curr', 'Y1_curr', 'Y2_curr', 'Y3_curr', 'Y4_curr', 'i_curr', ...
