...
fprintf('** Running func_S3TTV_gs_for_denoising_SPDHG_v2 **\n');
...
% sigma_Y1 = gpuArray(single(params.prob_patch/(sq_opnorm_Dl * sq_opnorm_D)));
...
for i = 1:maxiter
    ...
    %     fprintf('|Y1_next - Y1|_{2} = %f', sum((Y1_next - Y1) .* (1-mask), "all"))
    % end

    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    % Updating Y2
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    Y2_tmp  = Y2 + sigma_Y2*(U_next + S_next);
