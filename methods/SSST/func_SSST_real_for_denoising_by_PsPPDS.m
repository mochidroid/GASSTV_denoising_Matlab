...
function [HSI_restored, removed_noise, other_result] ...
     = func_SSST_real_for_denoising_by_PsPPDS(HSI_noisy, params)
fprintf('** Running func_SSST_real_for_denoising_by_PsPPDS **\n');
