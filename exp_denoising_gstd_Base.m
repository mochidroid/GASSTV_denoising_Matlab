...
methods_info(1) = struct( ...
    "name", "params_GASSTV.NL_OraG", ...
    "func", @(HSI_clean, HSI_noisy, params, deg) ...
        select_func_params_GASSTV.NL_OraG_for_denoising(HSI_clean, HSI_noisy, params, deg), ...
...
% params_GASSTV.GTV_Oraguide_Const
params_GASSTV.sigma_sp = {"90", "med"};
params_GASSTV.sigma_l = {"90", "med"};
params_GASSTV.lambda_rho_sp = [0.9, 1, 1.1, 1.2];
% params_GASSTV.lambda1 = [0.01];
