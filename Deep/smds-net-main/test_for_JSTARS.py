...
# parser.add_argument("--num_filters", type=lambda s: [int(item) for item in s.split(',')], help="Number of filters", default="9,9,9")
# parser.add_argument("--num_filters", type=lambda s: [int(item) for item in s.split(',')], help="Number of filters", default="9,9,9")
parser.add_argument("--num_filters", type=int, dest="num_filters", help="Number of filters", default=[9,9,9])
# parser.add_argument("--num_filters", type=int, dest="num_filters", help="Number of filters", default=[9,5,5])
...
#data
parser.add_argument("--model_name", type=str, dest="model_name", help="The name of the model to be saved.", default="./trained_model/ICVL_15_ckpt")
# parser.add_argument("--model_name", type=str, dest="model_name", help="The name of the model to be saved.", default=None)
parser.add_argument("--test_path", type=str, help="Path to the dir containing the testing datasets.", default="../Dataset/JasperRidge/g01_ps005_pt005/")
parser.add_argument("--tqdm", type=str2bool, default=False)
parser.add_argument("--gt_path", type=str, help="Path to the dir containing the ground truth datasets.", default="../Dataset/JasperRidge/g01_ps005_pt005/")
...
# print(f'num_filters: {args.num_filters}, type: {type(args.num_filters)}')
