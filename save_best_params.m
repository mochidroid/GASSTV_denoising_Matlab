...
for idx_params_comb = 1:num_params_comb
    ...
    load(fullfile(dir_result_folder, name_params_savetext), ...
...
if ismember("rho_radius", cellstr(methods_info(idx_method).param_names))
    ...
    for idx_rho = 1:num_rho
        ...
        for idx_params_comb = (idx_rho-1)*num_params_comb_each_rho + 1:idx_rho*num_params_comb_each_rho
            ...
            load(fullfile(dir_result_folder, name_params_savetext), "val_mpsnr"); 
        ...
        fprintf("best param (rho = %.2f): %s, MPSNR: %#.4g\n", rho, best_params_savetext, val_max_mpsnr)
    end   
end
