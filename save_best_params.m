...
methods_info(end+1) = struct( ...
    "name", "S3TTV_NPPDS", ...
    "param_names", {{"blocksize", "maxiter", "stopcri", "rho_radius"}}, ...
...
methods_info(end+1) = struct( ...
    "name", "S3TTV_SPDHG", ...
    "param_names", {{"blocksize", "prob_patch", "eta", "maxiter", "stopcri", "rho_radius"}}, ...
    "params", {{params_S3TTV.blocksize, params_S3TTV.prob_patch, params_S3TTV.eta, maxiter, stopcri, rhos}}, ...
    "get_params_savetext", @(params) ...
